...
#         print("HI: ",n_sum_sentence)
        ...
        source = tokenizer.batch_encode_plus(temp, max_length = 512, pad_to_max_length=True, truncation=True, padding="max_length", return_tensors="pt", )        
...
#         source = tokenizer.batch_encode_plus([source_text], max_length = 512, pad_to_max_length=True, truncation=True, padding="max_length", return_tensors="pt" )
        source_ids, source_mask = source["input_ids"][idx].squeeze(), source["attention_mask"][idx].squeeze()
#         print("========== BEFORE ==========")
#         print(source_ids)
